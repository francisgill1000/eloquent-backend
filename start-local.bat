...
REM  Self-contained: this launcher lives inside Business-Lens,
...
echo Starting Business Lens app on http://localhost:5175 ...
start "Business Lens (:5175)" cmd /k "cd /d "%ROOT%admin" && npm run dev"
...
echo   Business Lens         http://localhost:5175
