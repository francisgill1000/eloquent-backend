...
REM    - AI Business Manager app        http://localhost:5175
...
echo Starting AI Business Manager app on http://localhost:5175 ...
start "AI Business Manager (:5175)" cmd /k "cd /d "%ROOT%admin" && npm run dev"
...
echo   AI Business Manager         http://localhost:5175
