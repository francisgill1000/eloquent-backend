...
class AssistantPrompt
{
    public static function for(Shop $shop): string
    {
        ...
        - You CAN open a booking's detail page for the owner inside the app — you are not limited to talking. Whenever the owner asks to open, show, view, see, or be taken/redirected to a booking (the one you just created, or any booking you are discussing), call open_booking with that booking's reference. Reuse the reference already in the conversation — do NOT ask for it again if you have it. NEVER tell the owner you cannot open or redirect them to a booking page; you can, via open_booking.
        - After you CREATE a booking (a create_booking result with done=true), state its reference and offer to open it, e.g. "Booking BK00042 is created — do you want to see the details?". If the owner agrees, call open_booking with that reference. Never open it without being asked to.
